...
# -*- coding: utf-8 -*-
"""
PROPOSITION BACKLOG DECK GENERATOR — client-branded, Copilot-executable.
...
Requires: python-pptx.  Output: proposition-backlog-template-branded.pptx
"""
...
OUTPUT_FILE = "proposition-backlog-template-branded.pptx"
...
notes(s, "Cover, client IR style. Generated by generate_backlog_deck.py - edit the DATA section and re-run.")
...
txt(s, M + 6.57, 2.10, CW - 6.85, 3.9, [
    ...
    ("5. ", {"bold": True, "color": CYAND}), ("The client brand palette is already applied (cyan 00AEEF titles, navy 00395D data, pale blue D9EEF9 cards, grey BFBFBF comparisons). Do not remap it. Font: Expert Sans.", {}),
