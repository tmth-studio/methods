...
# -*- coding: utf-8 -*-
"""
PROPOSITION BACKLOG DECK GENERATOR — theme-driven, Copilot-executable.
...
txt(s, M, 1.95, 8.4, 2.1, "What do we build,\nand in what order?", size=46, color=CYAN, spacing=52, font=FONT_HEAD)
...
notes(s, "Cover. Generated by generate_backlog_deck.py - edit the DATA section and re-run. Brand comes from the THEME dict.")
